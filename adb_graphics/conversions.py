...
def k_to_c(field: ndarray, **kwargs):
...
def kgm2_to_in(field: ndarray, **kwargs):
...
def to_micrograms_per_m3(field: ndarray, **kwargs):
    """Convert field to micrograms per cubic meter."""

    return field * 1e9


def vvel_scale(field: ndarray, **kwargs):
    """Scale vertical velocity for plotting."""

    return field * -10


def vort_scale(field: ndarray, **kwargs):
    """Scale vorticity for plotting."""

    return field / 1e-05


def weasd_to_1hsnw(field: ndarray, **kwargs):
